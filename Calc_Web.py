...
def team_desc(Data):
    ...
    for j in range(len(team_stats)):
        ...
        team_stats.loc[j,'Predicted Score'] = team_stats.at[j, 'AVG_AMPLIF_TELE'] + team_stats.at[j, 'AVG_AMP_AUTO']*2 + team_stats.at[j, 'AVG_SPEAKER_AUTO']*5 + team_stats.at[j, 'AVG_AMP_TELE']*1 + team_stats.at[j, 'AVG_SPEAKER_TELE']*2
